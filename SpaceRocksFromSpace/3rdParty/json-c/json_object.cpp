...
{
	return (struct json_object_object *)jso;
}
...
{
	return get_string_component_mutable((struct json_object*) jso); // (void*)(uintptr_t)(const void*)jso);
}
...
static int json_object_copy_serializer_data(struct json_object *src, struct json_object *dst)
{
	...
	{
		dst->_userdata = _strdup((const char*)src->_userdata);
	}
